...
// Se o projeto está em um subdiretório, remove o base path da URI
$basePath = '/'; // Ajuste conforme seu RewriteBase no .htaccess
...
// Se o usuário não está logado, a única rota permitida é '/login' ou '/welcome'
...
// Lógica para obter o tema da sessão
...
switch ($route) {
    case '': // Rota padrão (home)
    case 'welcome':
        // A página de welcome é uma view que não precisa de um controlador PHP separado extenso.
        // O header de redirecionamento já está no controllers/welcome.php
    ...
    case 'rotinas': // Usando /rotinas para o seu painel.php
        // Ajuste a lógica de painel.php para usar $param1 para ações GET (ex: /rotinas/excluir/ID)
        // e $_POST para ações POST.
    ...
    case 'admin': // Para rotas de administração como usuários
        if ($param1 === 'usuarios') {
            ...
            // Para as submissões de formulário (POST), $action já virá no $_POST
            // e os IDs também.
